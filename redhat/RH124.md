<h1> <p align="center">RH124 Notes</p> </h1>
...
RedHat Enterpise Linux uses NetworkManager to do it's netowrking. Below are some ways to interact with it.
...
`/etc/resolv.conf` - Has DNS infomation. This Includes **hostname** and **nameservers**.
...
- `hostnamectl` - Gives infomation about the host. Below is an example.

![hostnamectl](/assets/images/hostnamectl.png)
...
The Red Hat CDN consistsns of 3 update branches.
- `RHBA` - Bug Fixes Advisory
- `RHEA` - Enhancements Advisory
- `RHSA` - Security Advisory 

To get this contenet you will need to register the server with the subscription you have. 
